...
|   M |  M0 | ef_construction | ef_search | load s | recall@10 |     QPS | avg ms | p50 ms | p90 ms | p99 ms | max ms |
| --: | --: | --------------: | --------: | -----: | --------: | ------: | -----: | -----: | -----: | -----: | -----: |
|  16 |  32 |             128 |        32 |  0.528 |    0.8897 | 13444.5 |  0.074 |  0.075 |  0.090 |  0.109 |  0.361 |
|  16 |  32 |             128 |        64 |  0.560 |    0.9564 |  7784.5 |  0.128 |  0.132 |  0.153 |  0.178 |  0.585 |
|  32 |  64 |             200 |        64 |  0.638 |    0.9783 |  5743.7 |  0.174 |  0.180 |  0.217 |  0.252 |  0.849 |
|  32 |  64 |             200 |       128 |  0.609 |    0.9948 |  3226.1 |  0.310 |  0.323 |  0.391 |  0.443 |  0.996 |
...
|   M |  M0 | ef_construction | ef_search | load s | recall@10 |    QPS | avg ms | p50 ms | p90 ms | p99 ms | max ms |
| --: | --: | --------------: | --------: | -----: | --------: | -----: | -----: | -----: | -----: | -----: | -----: |
|  16 |  32 |             128 |        32 |  0.089 |    0.9866 | 8017.7 |  0.125 |  0.126 |  0.156 |  0.185 |  0.497 |
|  16 |  32 |             128 |        64 |  0.089 |    0.9981 | 4849.5 |  0.206 |  0.209 |  0.261 |  0.311 |  0.756 |
|  32 |  64 |             200 |        64 |  0.111 |    0.9986 | 3901.2 |  0.256 |  0.261 |  0.335 |  0.400 |  0.744 |
|  32 |  64 |             200 |       128 |  0.107 |    0.9998 | 2413.7 |  0.414 |  0.421 |  0.552 |  0.657 |  1.425 |
